...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        AppSettings anotherInstance = AppSettings.getInstance();
        System.out.println("app.name=" + anotherInstance.get("app.name"));
        System.out.println("instance=" + System.identityHashCode(anotherInstance));
    }
}
